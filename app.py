...
annual_income_lpa = st.number_input("Enter ur annual income : ")
policy_term_year = st.number_input("Enter policy in yr")
Sum_Assured_Lakhs = st.number_input("assured in lks : ")
